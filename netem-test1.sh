...
sudo tc qdisc add dev $in_interface parent 1:2 handle 20: netem delay 25ms 20ms 25% distribution normal loss 5

sudo tc qdisc add dev $out_interface parent 1:1 handle 10: pfifo
sudo tc qdisc add dev $out_interface parent 1:2 handle 20: netem delay 25ms 20ms 25% distribution normal loss 5
